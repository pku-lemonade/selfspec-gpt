...
Define how to configure and apply post-load Gaussian noise to *draft model* weights for speculative decoding, with per-layer bucket assignments using discrete noise levels backed by a shared level→std table.
