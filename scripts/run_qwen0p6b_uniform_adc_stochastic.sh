...
OUTPUT_PATH="${OUTPUT_PATH:-checkpoints/Qwen/Qwen3-0.6B/model_wikitext_noise_ft_rel10_uniform_adc8_stochastic_step50.pth}"
SAVE_DIR="${SAVE_DIR:-out/ft_qwen0p6b_rel10_uniform_adc8_stochastic_step50}"
...
STUDENT_ADC_THRESHOLD_JITTER="${STUDENT_ADC_THRESHOLD_JITTER:-0.0}"
...
python scripts/finetune_noise_wikitext.py \
  ...
  --student_adc_threshold_jitter "$STUDENT_ADC_THRESHOLD_JITTER" \
